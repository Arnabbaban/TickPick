import 'package:get/get.dart';import 'listellipse5_item_model.dart';import 'listaction_item_model.dart';import 'package:tickpick/data/models/selectionPopupModel/selection_popup_model.dart';class AllActivityModel {Rx<List<Listellipse5ItemModel>> listellipse5ItemList = Rx(List.generate(3,(index) => Listellipse5ItemModel()));
